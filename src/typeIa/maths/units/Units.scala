...
object Units{
  ...
  final case class Quantity[M <: MReal, KG <: MReal, S <: MReal, K <: MReal, Mol <: MReal, CD <: MReal](value: Double) extends AnyVal {
    ...
    @inline def `²` = Quantity[M * _2_0, KG * _2_0, S * _2_0, K * _2_0, Mol * _2_0, CD * _2_0](value * value)
    @inline def √  = Quantity[M / _2_0, KG / _2_0, S / _2_0, K / _2_0, Mol / _2_0, CD / _2_0](math.sqrt(value))
    @inline def `¹⸍²`  = Quantity[M / _2_0, KG / _2_0, S / _2_0, K / _2_0, Mol / _2_0, CD / _2_0](math.sqrt(value))
    @inline def `¯¹⸍²`  = Quantity[--[M *_0_5], --[KG * _0_5], --[S * _0_5], --[K*_0_5], --[Mol*_0_5], --[CD*_0_5]](1/math.sqrt(value))
    @inline def `³` = Quantity[M * _3_0, KG * _3_0, S * _3_0, K * _3_0, Mol * _3_0, CD * _3_0](value * value * value)
    @inline def `³⸍²`  = Quantity[M * _1_5, KG * _1_5, S * _1_5, K * _1_5, Mol * _1_5, CD * _1_5](math.sqrt(value))
    @inline def ∛ = Quantity[M / _3_0, KG / _3_0, S / _3_0, K / _3_0, Mol / _3_0, CD / _3_0](math.cbrt(value))
    @inline def `⁴` = Quantity[M * _4_0, KG * _4_0, S * _4_0, K * _4_0, Mol * _4_0, CD * _4_0](value*value*value*value)
    @inline def ∜ = Quantity[M / _4_0, KG / _4_0, S / _4_0, K / _4_0, Mol / _4_0, CD / _4_0](math.pow(value, 0.25))
