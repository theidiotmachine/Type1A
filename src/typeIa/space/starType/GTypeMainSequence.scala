 ...
 */
object GTypeMainSequence extends MainSequence{
  /**
   ...
   */
  override def surfaceTemperatureMax: DegreesKelvin = new DegreesKelvin(6000)
   ...
   */
  override def surfaceTemperatureMin: DegreesKelvin = new DegreesKelvin(5200)
